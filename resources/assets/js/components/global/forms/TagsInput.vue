...
<template>
    <div class="tags-input-container">
        ...
        <div class="tags-input" v-on:click="focusTagInput()">
            <div class="selected-tag" v-for="(selected,key) in tagsArray" :key=key>
                {{ selected }}
            ...
            v-on:keyup.enter="addNewTag" v-on:keydown.up="changeIndex('up')"
            v-on:keyup.delete="handleDelete"
...
export default {
    ...
    methods:{
        ...
        changeIndex(direction){
            ...
            if(direction === 'down' && (this.searchSelectedIndex + 1<= this.tagSearchResults -1)){
                this.searchSelectedIndex=this.searchSelectedIndex+1;
                this.currentTag=this.tagSearchResults[this.searchSelectedIndex].tag;
            }
        },
